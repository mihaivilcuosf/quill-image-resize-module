...
/* harmony default export */ const DefaultOptions = ({
  modules: ['DisplaySize', 'Toolbar', 'Resize', 'Alt'],
  overlayStyles: {
    position: 'absolute',
...
class DisplaySize extends BaseModule {
  constructor() {
    return super(...arguments), this.onCreate = () => {
    ...
    }, this.getCurrentSize = () => [this.img.width, Math.round(this.img.width / this.img.naturalWidth * this.img.naturalHeight)], this;
  }
}
// EXTERNAL MODULE: ./node_modules/quill/assets/icons/align-left.svg
var align_left = __webpack_require__(2222);
...
var align_center = __webpack_require__(1505);
...
var align_right = __webpack_require__(496);
var align_right_default = /*#__PURE__*/__webpack_require__.n(align_right);
;// CONCATENATED MODULE: external ["exports","Quill"]
const external_exports_Quill_namespaceObject = window["exports"]["Quill"];
var external_exports_Quill_default = /*#__PURE__*/__webpack_require__.n(external_exports_Quill_namespaceObject);
...
const Quill = window.Quill || (external_exports_Quill_default());
...
class Toolbar extends BaseModule {
  constructor() {
    ...
    }, this.onDestroy = () => {}, this.onUpdate = () => {}, this._defineAlignments = () => {
      this.alignments = [{
...
;// CONCATENATED MODULE: ./src/modules/Alt.js

class Alt extends BaseModule {
  constructor() {
    return super(...arguments), this.onCreate = () => {
      // Create the container to hold the size display
      this.display = document.createElement('div');
...
class ImageResize {
  constructor(quill) {
    ...
    this.options = defaultsDeep_default()({}, options, DefaultOptions);
...
window.ImageResize = __webpack_exports__;
/******/ })()
;